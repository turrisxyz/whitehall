describe('GOVUK.adminEditionsForm', function () {
  ...
  describe('foreign language handling', function () {
    ...
    it('shows the locale input when foreign language only is checked', function () {
      form.find('#create_foreign_language_only').click()
      expect(form.find('.foreign-language-select').is(':hidden')).toBeFalse()
    })

    it('hides and resets the locale input when foreign language only is unchecked', function () {
      form.find('#create_foreign_language_only').click().click()
      expect(form.find('.foreign-language-select').is(':hidden')).toBeTrue()
    })
